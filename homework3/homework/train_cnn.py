...
def train(args):
    ...
    # data loader
    # train_data_loader = load_data('data/train', batch_size=batch_size, random_crop=(60,60), flip=True, color_aug=True, random_erase=True)
    train_data_loader = load_data('data/train', batch_size=batch_size, resize=(60,60), flip=True, color_aug=True, random_erase=True)
